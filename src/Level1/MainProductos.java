...
import Level1.classes.Producto;
import Level1.classes.Venta;
...
public class MainProductos {
    ...
    public static void main(String[] args) {
        ...
        Producto p3 = new Producto("Desodorante", 4.5);
        ...
        try {
            System.out.println("Funcionamiento correcto: El total de esta venta es: " + cesta.calculateTotal() + " euros.");
        } catch (VentaVacia e) {
            System.out.println(e.getMessage());
        }
...

        {
...

            {
                try {
                    ...
                    System.out.printf("Este es el total a pagar despues del  descuento: %.2f%n",  tresPorUno);
